  ...
  return (
    <main
      style={{
        ...
        padding: "2rem",
        gap: "4rem", // Espacio entre el logo y la card
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem", maxWidth: "280px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            <span style={{ fontSize: "14px", color: "rgba(255,255,255,0.7)", letterSpacing: "4px", textTransform: "uppercase" }}>
              in
            </span>
        ...
        <div style={{ display: "flex", gap: "1.5rem" }}>
          {[
            ["100%", "Digital"],
            ["24/7", lang === "es" ? "Disponible" : "Available"],
            ["QR", lang === "es" ? "Retiro seguro" : "Safe pickup"],
          ].map(([num, label]) => (
      ...
      >
        ...
        {/* Selección de Roles (Solo en Registro) */}
        {!isLogin && (
          <div style={{ marginBottom: "1.5rem" }}>
            <label style={{ fontSize: "12px", color: "#777", marginBottom: "8px", display: "block" }}>
              {t.userType}
            </label>
...
// Estilo de input reutilizable para limpiar el JSX
const inputStyle = {
  width: "100%",
  padding: "11px 14px",
