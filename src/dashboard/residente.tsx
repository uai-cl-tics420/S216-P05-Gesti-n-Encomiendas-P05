    ...
    <main style={{minHeight: '100vh', background: '#f5f5f5', fontFamily: 'sans-serif'}}>
      ...
      <div style={{padding: '2rem', maxWidth: '900px', margin: '0 auto'}}>
        ...
        <div style={{background: 'white', borderRadius: '12px', border: '0.5px solid #e0e0e0', overflow: 'hidden'}}>
          ...
          {[
            {code: 'PKG-001', desc: 'Caja Amazon', date: '15 Abr', status: t.pending, color: '#EF5350', otp: '4821'},
            {code: 'PKG-002', desc: 'Pedido Cornershop', date: '15 Abr', status: t.pending, color: '#EF5350', otp: '7392'},
